...
"Leader Mapping for EasyMotion
let g:EasyMotion_leader_key='<Space>'

"Change Emmet mapping from <C-y,>  to  <C-e>"
...
" Reduce timeout after <ESC> is recovered. This is only a good idea on fast links.
set ttimeout
set ttimeoutlen=20
set notimeout
...
"key to insert mode with paste using fn + F2 key
